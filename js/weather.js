...
$(".destination-btn").on("click", function() {
    ...
    $.ajax({
        ...
        weatherDiv.html(
            ...
            "<img src=\"https:" + weatherImg + "\">" + "<br>" +
            "Current Weather: " + weather + "<br>" +
            "<span class=\"temperature\" data-category=\"Current Temperature: \" data-feelslike-f=\"" + feelsLike + "\" data-feelslike-c=\"" + feelsLikeC + "\" data-f=\"" + temp + "\" data-c=\"" + tempC + "\" data-state=\"fahrenheit\">Current Temperature: " + temp + "°F</span>" + "<br>" +
            "<span class=\"temperature\" data-category=\"Feels Like: \" data-feelslike-f=\"" + feelsLike + "\" data-feelslike-c=\"" + feelsLikeC + "\" data-state=\"fahrenheit\">Feels Like: " + feelsLike + "°F</span>" + "<br>" +
            "Humidity: " + humidity)
